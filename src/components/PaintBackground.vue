  ...
  methods: {
    paintTheWall() {
      ...
      this.goo = function(parent, id) {
        ...
        let waves = [] // this will contain the information for each wave (color, drip positions, etc...)
            ...
            if (waves[i] != undefined) {
              ...
              for (var c = 0; c < waves[i].drips.length; c++) {
                ...
                waves[i].drips[c] +=
                  ...
                  (window.noise.simplex2(i * dripsAmount + c, currentTime) +
                    1) *
